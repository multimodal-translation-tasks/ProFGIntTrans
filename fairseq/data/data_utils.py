...
def load_img_features(imag_npy_path):
    ...
    # # grid_img_features = grid_img_features[torch.randperm(grid_img_features.size(0))]

    region_img_features = open(imag_npy_path + '.pkl',   'rb')
    region_img_features = pickle.load(region_img_features)
    # region_img_features = np.random.permutation(region_img_features)
    # region_img_features = random.shuffle(region_img_features)
